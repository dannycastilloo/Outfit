        ...
        <>
            <div className="filter-table">
                <form className="d-flex filter-pc" role="search">
                    <input className="form-control me-2" type="search" placeholder="Buscar por cliente, estado u otros" aria-label="Search"></input>
                </form>
                ...
                <>
                    ...
                    <div className="modal-overlay">
                        <div className="modal-container" ref={modalRef}>
                            <RegisterCliente closeModal={closeModal} />
                        </div>
                    </div>
                </>
            )}
